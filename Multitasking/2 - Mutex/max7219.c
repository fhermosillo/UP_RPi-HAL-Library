...
// SPI Communication
static SPI_t *MAX7219_SPI = NULL;
static eSPIChip MAX7219_CS = SPI_CHIP_0;
...
void MAX7219_Begin(SPI_t *SPIx, eSPIChip chip)
{
	...
	if(SPIx == NULL)
	{
		...
		MAX7219_SPI = HAL_SPI_Init(SPI0_DRIVER);
		HAL_SPI_Set_Baud(MAX7219_SPI, MHZ(1));
	} else
	{
		MAX7219_SPI = SPIx;
	}
...
void MAX7219_WriteReg(uint8_t reg, uint8_t data)
{
      ...
      HAL_SPI_Set_Mode(MAX7219_SPI,SPI_MODE_0);
      HAL_SPI_Set_Chip(MAX7219_SPI, MAX7219_CS, SPI_CHIP_POL_LOW);
      HAL_SPI_Transfern(MAX7219_SPI,txbuf,NULL,2);
}
